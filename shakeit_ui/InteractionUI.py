...
"}")
        ...
        self.tiLogo.setText("")
        self.tiLogo.setPixmap(QtGui.QPixmap("ros_pkg_ws/src/shakeit_ui/resource/tilogo.png"))
...
"image: url(src/shakeit_ui/resource/flipicon.png);")
        ...
        self.buttonEnd.setStyleSheet("image: url(src/shakeit_ui/resource//s1r1.png);")
        self.buttonEnd.setObjectName("buttonEnd")
        self.gridLayout_5.addWidget(self.buttonEnd, 0, 0, 1, 1)
...
"image: url(src/shakeit_ui/resource/backicon.png);")
        ...
        self.pushButton_23.setStyleSheet("image: url(src/shakeit_ui/resource//s4r1.png);")
        ...
        self.pushButton_24.setStyleSheet("image: url(src/shakeit_ui/resource//s2r3.png);")
        ...
        self.pushButton_25.setStyleSheet("image: url(src/shakeit_ui/resource//s2r1.png);")
        ...
        self.pushButton_26.setStyleSheet("image: url(src/shakeit_ui/resource//s1r3.png);")
        ...
        self.pushButton_27.setStyleSheet("image: url(src/shakeit_ui/resource//s5r1.png);")
        ...
        self.pushButton_28.setStyleSheet("image: url(src/shakeit_ui/resource//s3r1.png);")
        ...
        self.pushButton_29.setStyleSheet("image: url(src/shakeit_ui/resource//s5r3.png);")
        ...
        self.pushButton_30.setStyleSheet("image: url(src/shakeit_ui/resource//s3r3.png);")
        ...
        self.pushButton_31.setStyleSheet("image: url(src/shakeit_ui/resource//s4r3.png);")
        ...
        self.pushButton_32.setStyleSheet("image: url(src/shakeit_ui/resource//s1r1.png);")
